const styles = {
    ...
    heading: 'text-[26px] text-center md:text-start font-[600] font-Roboto pb-[15px]',
    ...
    button: 'w-[150px] bg-black h-[50px] my-3 flex items-center justify-center rounded-md cursor-pointer',
