const styles = {
    ...
    heading: 'text-[26px] text-center md:text-start font-[600] pb-[15px]',
    section:'w-11/12 mx-auto',
    productTitle: 'text-[25px] text-[#333]',
    productDiscountPrice:"font-bold text-[18px] text-[#333]",
    price:"font-[500] text-[16px] text-[#d55b45] pl-3 mt-[-4px] line-through",
    shop_name:"pt-3 text-[15px] text-[#0077B6] pb-3",
    active_indicator:"absolute bottom-[-27%] left-0 h-[3px] w-full bg-[#00b4d8]",
