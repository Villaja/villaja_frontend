...
const Cart = ({ setOpenCart }) => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full bg-[#0000004b] h-[125vh] z-10">
    ...
    <div className="border-b p-4">
      <div className="w-full flex items-center">
        ...
        <img
          ...
          alt=""
          className="w-[60px] h-12 ml-2 mr-2 rounded-[5px]"
        />
        <div className="pl-[5px]">
          ...
          <h4 className="font-[600] text-[17px] pt-[3px] text-[#00b4d8] font-Roboto">
           ₦{totalPrice}
          </h4>
        </div>
        <RxCross1
          className="ml-8 text-red-500 font-bold cursor-pointer"
