   ...
   <>
    {
      adminOrderLoading ? (
        ...
        <div className="w-full block 800px:flex items-center justify-between">
          <div className="w-full mb-4 800px:w-[30%] min-h-[20vh] bg-white shadow rounded px-6 py-5">
            ...
            <h5 className="pt-2 pl-[36px] text-[22px] font-[500]">{adminBalance} NGN</h5>
            <Link to="/admin-withdraw-request">
              <h5 className="pt-4 pl-2 text-[#077f9c]">Withdraw Requests</h5>
            </Link>
          </div>
