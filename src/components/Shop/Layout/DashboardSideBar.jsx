    ...
    <div className="w-full h-[90vh] bg-white shadow-sm overflow-y-scroll sticky top-0 left-0 z-10">
      ...
      <div className="w-full flex items-center p-4">
        <Link to="/dashboard-products" className="w-full flex items-center">
          ...
          <h5
            className={`hidden 800px:block pl-2 text-[18px] font-bold ${
              active === 3 ? "text-blue-500" : "text-[#555]"
            }`}
          >
            All Products
          </h5>
      ...
      <div className="w-full flex items-center p-4">
        ...
        >
          ...
          <h5
            className={`hidden 800px:block pl-2 text-[18px] font-bold ${
              active === 4 ? "text-blue-500" : "text-[#555]"
            }`}
          >
            Create Product
          </h5>
      ...
      <div className="w-full flex items-center p-4">
        <Link to="/dashboard-create-event" className="w-full flex items-center">
          ...
          <h5
            className={`hidden 800px:block pl-2 text-[18px] font-bold ${
              active === 6 ? "text-blue-500" : "text-[#555]"
            }`}
          >
            Create Event
          </h5>
      ...
      <div className="w-full flex items-center p-4">
        ...
        >
          ...
          <h5
            className={`hidden 800px:block pl-2 text-[18px] font-bold ${
              active === 7 ? "text-blue-500" : "text-[#555]"
            }`}
          >
            Withdraw Money
          </h5>
      ...
      {/* <div className="w-full flex items-center p-4">
        <Link to="/dashboard-messages" className="w-full flex items-center">
          ...
          <h5
            className={`hidden 800px:block pl-2 text-[18px] font-bold ${
              active === 8 ? "text-blue-500" : "text-[#555]"
            }`}
          >
            Messages
          </h5>
      ...
      {/* <div className="w-full flex items-center p-4">
        <Link to="/dashboard-coupouns" className="w-full flex items-center">
          ...
          <h5
            className={`hidden 800px:block pl-2 text-[18px] font-bold ${
              active === 9 ? "text-blue-500" : "text-[#555]"
            }`}
          >
            Discount Codes
          </h5>
      ...
      {/* <div className="w-full flex items-center p-4">
        <Link to="/dashboard-refunds" className="w-full flex items-center">
          ...
          <h5
            className={`hidden 800px:block pl-2 text-[18px] font-bold ${
              active === 10 ? "text-blue-500" : "text-[#555]"
            }`}
          >
            Refunds
          </h5>
      ...
      <div className="w-full flex items-center p-4">
        <Link to="/settings" className="w-full flex items-center">
          ...
          <h5
            className={`hidden 800px:block pl-2 text-[18px] font-bold ${
              active === 11 ? "text-blue-500" : "text-[#555]"
            }`}
          >
            Settings
          </h5>
