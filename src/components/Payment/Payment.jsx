...
const PaymentInfo = ({
  ...
  return (
    <div className="w-full 800px:w-[95%] bg-[#fff] rounded-md p-5 pb-8">
      ...
      <div>
        {/* <div className="flex w-full pb-5 border-b mb-2">
          ...
          <h4 className="text-[18px] pl-2 font-[600] text-[#000000b1]">
            Pay with Debit/credit card | comming soon !
          </h4>
        </div> */}
      ...
      <p className="mt-4 font-bold text-sm text-gray-500">Credit Card and Paypal Payment comming soon</p>
    </div>
  );
};
